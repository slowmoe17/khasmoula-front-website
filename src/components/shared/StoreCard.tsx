    ...
    <div className="bg-white pt-5 rounded-[10px] shadow-[0px_0px_3px_0px_#00000040]">
      ...
      <div className="flex items-center justify-center flex-col -mt-[15px]">
        ...
        <div className="flex items-center justify-center gap-5 mt-9.5 px-9 pb-7">
          <Button className="w-1/2 font-semibold text-xl py-[17px] px-5 h-12 text-white">
            عرض الكوبونات
          </Button>
          <Button
            variant="outline"
            className="w-1/2 font-semibold text-xl py-[17px] px-5 h-12 text-primary border-primary"
          >
            عرض المتجر
          </Button>
        </div>
